<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT id, username, pw FROM stureg WHERE username = '$username' AND activated = '1' LIMIT 1";
...
<li class="dropdown">
 ...
 <li><a href="academic.php">Academic Registration</a></li>
...
<div class="form">
<strong>
        <form method="post" action="stulogin.php"><br>
