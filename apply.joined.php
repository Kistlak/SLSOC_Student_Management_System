...
$sql = "INSERT INTO apply (fname,lname,adone,adtwo,city,country,num,email,gender,year,month,date) VALUES
...
echo " ".$_POST["fname"]." ".$_POST["lname"]." , You Have Successfully Registed !! <br><br>
