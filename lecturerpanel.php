...
<h2 class="seh2">Sri Lanka School Of Computing Faculty</h2>

<img src="SOC Lec 1.jpg" style="float:right;marign-right:50px;margin-top:80px" width="400px"></img>
...
<table class="fac">
  ...
  <tr style="background-color: #dddddd;">
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;"><a class="lec" href="lec1.php">Mr. Somasiri Kahandagamage</a></td>
    <td>Head Of SLSOC<br>Professor of Computer Science</td>
  </tr>
  <tr>
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;"><a class="lec" href="lec2.php">Mrs. Shiyani Kahandagamage</a></td>
    <td>Professor of Software Engineering</td>
  </tr>
  <tr style="background-color: #dddddd;">
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Mr. Norman Rajapaksha</td>
    <td>Associate Professor Of Computer Science</td>
  </tr>
  <tr>
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Mrs. Thushari Rajapaksha</td>
    <td>Associate Professor Of Software Engineering</td>
  </tr>
  <tr style="background-color: #dddddd;">
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Mr. Mahesh Gunathilaka</td>
    <td>Lecturer</td>
  </tr>
  <tr>
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Mr. Dinesh Umayanga</td>
    <td>Lecturer</td>
  </tr>
<tr style="background-color: #dddddd;">
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Ms. Champa Dikpitiya</td>
    <td>Lecturer</td>
  </tr>
<tr>
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Mr. Isira Kalhara</td>
    <td>Lecturer</td>
  </tr>
<tr style="background-color: #dddddd;">
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Ms. Wasana Heenatigala</td>
    <td>Lecturer</td>
  </tr>
<tr>
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Mr. Amila Lakshan</td>
    <td>Lecturer</td>
  </tr>
<tr style="background-color: #dddddd;">
    <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">Ms. Achini Perera</td>
    <td>Lecturer</td>
  </tr>
</table>
