...
<h2 class="seh2">Welcome To The Software Engineering Unit.</h2>

<center><img src="SOC Lab 4.jpg" width="800px" height="400px"></img></center><br>

<p class="about">
Sri Lanka School Of Computing provides BSc (Honours) Software Engineering Degree. In this section you can learn C Language , Oracle SQL , MS SQL , C# Language , C++ Language , HTML , CSS , Java Script , JQuery , Java Language and Etc..
After you have finished this Degree programme , you can be a Genuine Software Engineer with some industrial experience.<br>

<li><a href="apply.php" class="btnhome" target="_blank">Apply Now</a></li><br><br>

</p> <!-- End Of The About Class -->

<p style="font-size:250%; margin-left:100px; color:#353c47; font-family:Times New Roman">What Is Software Engineering ?<br>
<iframe width="854" height="480" src="https://www.youtube.com/embed/bFmThPwKRGU" frameborder="0" allowfullscreen></iframe></p>
