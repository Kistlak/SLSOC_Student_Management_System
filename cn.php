...
<h2 class="csech2">Welcome To The Computer Network Unit.</h2>

<center><img src="SOC Lab 3.jpg" width="800px" height="400px"></img></center><br>

<p class="about">
Sri Lanka School Of Computing provides BSc (Honours) Computer Network Degree. In this section you can learn C Language , Oracle SQL , MS SQL , C# Language , C++ Language , HTML , CSS , Java Script , JQuery , Java Language , Network Terminology and Etc..
After you have finished this Degree programme , you can be a Genuine Computer Networker with some industrial experience.<br>

<li><a href="apply.php" class="btnhome" target="_blank">Apply Now</a></li><br><br>

</p> <!-- End Of The About Class -->

<p style="font-size:250%; margin-left:100px; color:#353c47; font-family:Times New Roman">Introduction to Computer Network<br>
<iframe width="854" height="480" src="https://www.youtube.com/embed/mxK4cH6DJwo" frameborder="0" allowfullscreen></iframe></p>
